...
MODEL=/mnt/bn/honglifish/model/Meta-Llama-3.1-8B-Instruct
GPUS_PER_NODE=8
NNODES=8
...
python3 -m verl.trainer.main_ppo \
    ...
    +trainer.val_before_training=False \
    trainer.critic_warmup=0 \
    trainer.logger=['console','tracking'] \
    trainer.project_name='verl_fish' \
    trainer.experiment_name=${NNODES}nodes/llama3-8b/openai_math_debug \
